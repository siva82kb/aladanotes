...
\begin{boxedstuff}
    \begin{example}
        ...
        \begin{small}
            ...
            \end{center}
        \end{small}
        The size of the score vectors tells us that students 1 and 2 performed worst among the six students, while students 5 and 6 performed the best; the performacne of students 3 and 4 was somehwere in the middle. \textcolor{blue}{Would we have reached similar conclusions if we had used the $1$-norm or the $\infty$-norm to compute the norms of the score vectors?}
...
\secsum{
    ...
    \begin{itemize}
        \item k-nearest neighbors (k-NN) classification algorithm
